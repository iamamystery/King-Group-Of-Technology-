        ...
        <div className="glass gradient-border rounded-2xl p-8 glow-purple">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="remember" className="text-sm text-[#A0A0B8] cursor-pointer">
                  Remember me
                </Label>
              </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#13131F] text-[#A0A0B8]">Or continue with</span>
            </div>
          </div>
          ...
          <p className="text-center text-[#A0A0B8] mt-8">
            ...
            <Link href="/auth/register" className="text-[#6C63FF] hover:text-[#00D4FF] transition-colors font-medium">
              Sign up
            </Link>
          </p>
        </div>
